...
IPAddress clientIP(192, 168, 1, 11);
...
char ssid[] = "PLDTHOMEFIBR3b578";        // your network SSID (name)
char pass[] = "PLDTWIFIsb5e7";         // your network password (use for WPA, or use as key for WEP), length must be 8+
...
void setup()
{
  ...
  socketIO.setExtraHeaders("Authorization: secret");
...
void loop()
{
  ...
  if (now - messageTimestamp > 30000)
  {
    ...
    Serial.println("---------------------------Print JSON for debugging---------------------------");
